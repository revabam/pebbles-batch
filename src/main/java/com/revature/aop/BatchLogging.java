 ...
 * @author obosanosa-igiebor, Ediide Grays, Batch: 1806-spark, Trainer: Steven Kelsey 
 *
 */
...
public class BatchLogging {
	...
	public void logBatch(JoinPoint joinPoint) throws Throwable{
		logger.info("Batches endpoint hit" + joinPoint);
		logger.error("Error!");
		logger.debug("Now Debugging...");
	}
